# -*- coding: utf-8 -*-
"""
Created on Mon Apr  1 21:28:29 2019
...
df_test = df_test.drop(['ID_code'], axis=1, inplace = True)
    


#labeled -1 are outliers
...
def use_selected_features(dataset, var_lst):
    lst = ['ID_code', 'target']
    lst.extend(var_lst)
    return dataset[lst]

df_train = use_selected_features(df_train, ['var_81'])
